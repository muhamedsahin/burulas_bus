...
function Hero() {
    ...
    return (
        <main>
            <div className="hero bg-slate-100 h-full flex">
                <div className="flex-1 pt-36 padding-x justify-center flex flex-row items-center">
                    ...
                    <div className="w-1/2 flex justify-center items-center">
                        <Image src="/bus.png" loading="lazy" alt="hero" width={500} height={300} className="object-contain" />
                    </div>
                </div>
            </div>
