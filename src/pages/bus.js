...
function BusPage() {
  ...
  return (
    <main className='min-h-screen bg-slate-100'>
      ...
      <NavBar />
      <div className="hero bg-slate-100 h-screen flex">
        <div className="flex-1 pt-36 padding-x justify-center flex flex-row">
          ...
          <div className="w-2/3 flex justify-center items-center p-5">
